                    ...
                    <tr>
                      <td align="center" style="padding-bottom: 20px;">
                        <div style="background-color: #ffffff; width: 60px; height: 60px; border-radius: 12px; display: inline-flex; align-items: center; justify-content: center; margin: 0 auto;">
                          <span style="font-size: 28px; font-weight: bold; color: #059669;">⚕️</span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center">
                        ...
                        <p style="color: #a7f3d0; font-size: 16px; margin: 8px 0 0 0;">Your trusted pharmacy partner</p>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td style="background-color: #f8fafc; padding: 30px 40px; text-align: center; border-radius: 0 0 12px 12px; border-top: 1px solid #e5e7eb;">
                  <p style="color: #6b7280; font-size: 14px; margin: 0 0 12px 0;">
                    ...
                    <a href="mailto:support@pharmnow.com" style="color: #059669; text-decoration: none;">support@pharmnow.com</a>
                  </p>
